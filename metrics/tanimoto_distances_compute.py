...
fingerprints_g = np.load("/projects/iktos/pierre/CondGeoLDM/metrics/fingerprints_data/geom_fingerprints.npy", allow_pickle=True)
...
np.save('/projects/iktos/pierre/CondGeoLDM/data/jump/best_hits_geom.npy', max_values)
print('done')